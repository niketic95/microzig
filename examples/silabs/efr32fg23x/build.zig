...
pub fn build(b: *std.Build) void {
    ...
    const efr32fg23b021 = mb.ports.efr32fg23x.chips.efr32fg23b021f512im48;

    const available_examples = [_]Example{
        .{ .name = "gpio_input", .target = efr32fg23b021, .file = "src/gpio_input.zig" },
    };
    ...
    for (available_examples) |example| {
        ...
        mb.install_firmware(firmware, .{ .format = .binary });
    }
}
